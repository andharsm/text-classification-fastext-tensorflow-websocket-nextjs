...
MODULE_PATH = "fastext_module"
MODEL_PATH = 'model/fasttext_model.h5' #ekstrak file fastext_module.zip
DATA_MASTER_PATH = 'data/data_master.pkl'
KEY_NORM_PATH = 'data/key_norm.csv'
...
exceptions = ['mana', 'akhir', 'mulai', 'lanjut', 'ikut', 'soal', 'tanya', 'tunjuk', 'sebut', 'jelas']
...
def match_data(kalimat):
    ...
    if norms_a == 0 or np.any(norms_b == 0):
        ...
        try:
            cosine_similarities = np.dot(data_embeddings, new_embedding) / (norms_a * norms_b)
